            ...
            <div className="w-full flex-col py-4.72 bg-food-pattern">
                <div className="sm:w-9/12 mx-14 xl:w-8/12 sm:mx-auto">
                    <div  className="w-10 h-10 rounded-full bg-white flex justify-center items-center shadow-lg">
                        <Link to={"/"}>
                            <svg  width="25px" height="25px" viewBox="0 0 1024 1024" fill="#000000" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" strokeWidth="38.912"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M669.6 849.6c8.8 8 22.4 7.2 30.4-1.6s7.2-22.4-1.6-30.4l-309.6-280c-8-7.2-8-17.6 0-24.8l309.6-270.4c8.8-8 9.6-21.6 2.4-30.4-8-8.8-21.6-9.6-30.4-2.4L360.8 480.8c-27.2 24-28 64-0.8 88.8l309.6 280z" fill=""></path></g></svg>
                        </Link>
                    </div>
                    <h1 className="mt-5 font-poppins font-bold text-orangered text-3xl lg:text-5xl">Sign In</h1>
                    <p className="mt-3 md:mt-5 text-base lg:text-lg font-poppins">Dont have an account? <Link to={"/signup"}><span className="text-orangered font-semibold underline text-wrap" >Create Now</span></Link></p>
                    ...
                    <div className="mt-5">
                        <Signup3rd title="Signin" image={GoogleIcon} name="Google"/>
                        <Signup3rd title="Signin" image={FacebookIcon} name="Facebook"/>
                    </div>
                </div>
            </div>
