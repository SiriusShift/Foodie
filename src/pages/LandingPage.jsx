    ...
    return(
        ...
        <div className="bg-food-pattern h-dvh px-16 lg:px-20">
            ...
            <div className="text-center pt-24">
                ...
                <Link className="2xl:px-8 2xl:py-4 xl:px-7 xl:py-3 lg:py-3 lg:px-6 md:py-3 md:px-5 py-3 px-5 bg-orangered font-poppins text-white shadow-md text-md text-sm lg:text-lg font-extrabold rounded-full">Try for free</Link>
            </div>
        </div>
        <Footer />
        </>
