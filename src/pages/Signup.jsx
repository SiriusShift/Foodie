        ...
        <div className="flex md:columns-2 flex-row">
            <div className="w-full flex flex-col bg-food-pattern">
                <div className="w-8/12 mx-auto">
                    ...
                    <p className="mt-5 text-lg font-poppins">Already have an account? <Link className="text-orangered font-semibold underline" to={"/login"}>Login Now</Link></p>
                    <div className="mt-10">
                        <h2 className="text-lg font-poppins indent-3 mb-2">Email</h2>
                        <input className="w-full border-y border-x border-x-slate-300 rounded-xl px-4 py-2 h-16 font-poppins" type="email" placeholder="SampleEmail@email.com"/>
                    </div>
                    <div className="mt-10">
                        <h2 className="text-lg font-poppins indent-3 mb-2">Password</h2>
                        <div className="flex w-full relative">
                            <input className="w-full border-y border-x border-x-slate-300 rounded-xl px-4 py-2 h-16 font-poppins" type={hide ? "password" : "text"} placeholder=""/>
                    ...
                    <div className="mt-10 flex items-center">
                        <input className="h-4 w-4 me-3" type="checkbox" />
