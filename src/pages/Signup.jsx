        ...
        <div className="flex md:columns-2">
            <div className="w-full flex-col py-4.72 bg-food-pattern">
                <div className="sm:w-9/12 mx-14 xl:w-8/12 sm:mx-auto">
                    ...
                    <h1 className="mt-5 font-poppins font-bold text-orangered text-3xl lg:text-5xl">Sign Up</h1>
                    <p className="mt-3 md:mt-5 text-base lg:text-lg font-poppins">Already have an account? <Link to={"/login"}><span className="text-orangered font-semibold underline text-wrap" >Login Now</span></Link></p>
                    <form onSubmit={handleSubmit}>                
                        <SignupInputs heading="Email"> 
                            <input onChange={handleChange} name="email" className="w-full border-y border-x border-x-slate-300 rounded-xl px-4 py-2 h-14 lg:h-16 font-poppins" type="email"/>
                        </SignupInputs>
                        <SignupInputs heading="Password">
                            <div className="flex w-full relative">
                                <input onChange={handleChange} name="password" className="w-full border-y border-x border-x-slate-300 rounded-xl px-4 py-2 h-14 lg:h-16 font-poppins" type={hide ? "password" : "text"} placeholder=""/>
