                    ...
                    <form onSubmit={handleSubmit}>                
                        ...
                        <SignupInputs heading="Password">
                            <div className="flex w-full relative">
                                <input onChange={handleChange} name="password" className="w-full border-y border-x border-x-slate-300 rounded-xl px-4 py-2 h-14 md:h-16 font-poppins" type={hide ? "password" : "text"} placeholder=""/>
