export default function Signup3rd({image, name}) {
    return(
        <div className="flex w-full items-center mt-6 rounded-full relative">
            ...
            <button className="w-full font-poppins font-semibold hover:bg-gray-100 button rounded-full h-14 lg:h-16 bg-white"><span className="text-sm lg:text-base">Signup with {name}</span></button>
        </div>
    )
}